...
TEXT_MONEY = ""; TEXT_PLAY = "PLAY"; TEXT_BET = ""; TEXT_COIN = ""; TEXT_MAX_BET = "MAX"; TEXT_INFO = ""; TEXT_LINES = ""; TEXT_SPIN = ""; TEXT_AUTOSPIN = "AUTO"; TEXT_WIN = "";
...
function CMain(a) {
    ...
    this._initSounds = function () {
        ...
        s_aSoundsInfo.push({ path: "./sounds/", filename: "bg_music", loop: 1, volume: 1, ingamename: "bg_music" });
        ...
        s_aSoundsInfo.push({ path: "./sounds/", filename: "reel_stop", loop: !1, volume: 1, ingamename: "reel_stop" });
        s_aSoundsInfo.push({ path: "./sounds/", filename: "game_over_bonus", loop: !1, volume: 1, ingamename: "game_over_bonus" });
        s_aSoundsInfo.push({ path: "./sounds/", filename: "reel_bonus", loop: !1, volume: 1, ingamename: "reel_bonus" });
        s_aSoundsInfo.push({ path: "./sounds/", filename: "start_reel_bonus", loop: !1, volume: 1, ingamename: "start_reel_bonus" });
        s_aSoundsInfo.push({ path: "./sounds/", filename: "win_bonus", loop: !1, volume: 1, ingamename: "win_bonus" });
...
function CGame(a) {
    ...
    this._init = function () {
        ...
        setInterval(function () {
            ...
            now = now - 1;
            Z = new createjs.Text(now, "14px " + FONT_GAME, "#ffb581");
...
function CInterface(a, f, d) {
    ...
    this._init = function (a, d, f) {
        ...
        r = new CTextButton(632 + p.width / 2, 548, p, TEXT_AUTOSPIN, FONT_GAME, "#063744", 35, s_oAttachSection);

        r.addEventListener(ON_MOUSE_UP, this._onAutoSpin, this);
        p = s_oSpriteLibrary.getSprite("spin_but");
        u = new CTextButton(719 + p.width / 2, 546, p, TEXT_SPIN, FONT_GAME, "#ffffff", 26, s_oAttachSection);
        u.addEventListener(ON_MOUSE_UP, this._onSpin, this);
        p = s_oSpriteLibrary.getSprite("info_but");
        x = new CTextButton(264 + p.width / 2, 561, p, TEXT_INFO, FONT_GAME, "#ffffff", 30, s_oAttachSection);
        ...
        y = new CTextButton(375 + p.width / 2, 561, p, TEXT_COIN, FONT_GAME, "#ffffff", 30, s_oAttachSection);
        y.addEventListener(ON_MOUSE_UP, this._onBet, this);
        p = s_oSpriteLibrary.getSprite("but_maxbet_bg");
        H = new CTextButton(784 + p.width / 2, 548, p, TEXT_MAX_BET, FONT_GAME, "#063744", 35, s_oAttachSection);
        H.addEventListener(ON_MOUSE_UP, this._onMaxBet, this);
        E = new CTLText(s_oAttachSection, 1090, 526, 128, 50, 24, "center", "#c3b47c", FONT_GAME, 1, 0, 0, TEXT_MONEY + "\n" + f.toFixed(2) + TEXT_CURRENCY, !0, !0, !0, !1);
        F = new CTLText(s_oAttachSection, 273, CANVAS_HEIGHT - 82, 134, 12, 30, "center", "#ffffff", FONT_GAME, 1, 0, 0, NUM_PAYLINES, !0, !0, !1, !1);
        // F.setShadow("#000", 1, 1, 2); 
        J = new CTLText(s_oAttachSection, 367, CANVAS_HEIGHT - 84, 134, 15, 30, "center", "#ffffff", FONT_GAME, 1, 0, 0, a.toFixed(2), !0, !0, !1, !1);
        // J.setShadow("#000", 1, 1, 2); 
        P = new CTLText(s_oAttachSection, 457, CANVAS_HEIGHT - 84, 174, 15, 30, "center", "#ffffff", FONT_GAME, 1, 0, 0, TEXT_BET + d.toFixed(2), !0, !0, !1, !1);
        // P.setShadow("#000", 1, 1, 2); 
        R = new CTLText(s_oAttachSection, 905, CANVAS_HEIGHT - 86, 134, 23, 30, "center", "#ffffff", FONT_GAME, 1, 0, 0, " ", !0, !0, !1, !1);
...
function CBonusPanel() {
    var a, f, d, e, g, m, k, l, h, b, c, t, u, X;

    // 000000000000000000000000000000000000000


    X = new createjs.Text("Wheel Bonus", "100px " + FONT_GAME, "#CDB30C");
    X.x = 750; X.y = 345; X.textAlign = "center";
    ...
    this._init = function () {
        ...
        b = new CLedsBonus(745, 310, u);
        f = b.getState();
        r = s_oSpriteLibrary.getSprite("but_spin_bonus");
        c = new CTextButton(695 + r.width / 2, 310, r, TEXT_SPIN, FONT_GAME, "#ffffff", 40, u);
        ...
        t = new CTLText(u, 680, 130, 102, 400, 76, "center", "#e21615", FONT_GAME, 1, 0, 0, TEXT_CURRENCY + "0", !0, !0, !1, !1);
        t.setAlpha(k)
    };
        ...
        s_aSession.iSlotCash += d;
         ...
         if (s_aSession.iSlotCash < s_aSession.min_win * f) return generLosingPattern(), 1 === s_aSession.bFreeSpin && (--s_aSession.iTotFreeSpin, 0 > s_aSession.iTotFreeSpin && (s_aSession.iTotFreeSpin = 0, s_aSession.bFreeSpin = 0)), "res=true&win=false&pattern=" + JSON.stringify(_aFinalSymbols) +
            ...
            if (Math.floor(100 * Math.random()) < s_aSession.win_occurrence) {
                ...
                var k; m = 0; 
                do { generateRandomSymbols(e, g); var l = checkWin(e, g, a), h = 0; for (k = 0; k < l.length; k++)h += l[k].amount; h *= f; var b = 0; k = -1; if (1 === g) { s_aSession.bBonus = 1; k = []; for (b = 0; b < s_aSession.bonus_prize_occur.length; b++)for (var c = s_aSession.bonus_prize_occur[b], t = 0; t < c; t++)k.push(b); k = k[Math.floor(Math.random() * k.length)]; b = s_aSession.bonus_prize[k] * f } m++ } while (0 === l.length || b + h > s_aSession.iSlotCash || b + h < d); 
       
                
                s_aSession.iMoney = s_aSession.iMoney + h + b; 
            ...
            1 === s_aSession.bFreeSpin && (--s_aSession.iTotFreeSpin, 0 > s_aSession.iTotFreeSpin && (s_aSession.iTotFreeSpin = 0, s_aSession.bFreeSpin = 0)); return "res=true&win=false&pattern=" + JSON.stringify(_aFinalSymbols) + "&money=" + s_aSession.iMoney + "&freespin=" + s_aSession.iTotFreeSpin + "&bonus=false&bonus_prize=-1&bonus_win=0";
...
function generLosingPattern() { 
    ...
    for (f = 0; f < NUM_ROWS; f++) { 
        _aFinalSymbols[f] = []; 
        for (var e = 0; e < NUM_REELS; e++)if (0 == e) _aFinalSymbols[f][e] = a[f]; else { do d = Math.floor(Math.random() * _aRandSymbols.length), d = _aRandSymbols[d]; while (a[0] === d || a[1] === d || a[2] === d || 9 === d || 10 === d || 8 === d); _aFinalSymbols[f][e] = d } 
...
function CCreditsPanel() {
    ...
    this._onLogoButRelease = function () { window.open("", "_blank") };
    this._init()
}
